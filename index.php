...
function magic(){
  ...
  if(window.scrollY > 40 && !scrollingUp){
  ...
  if(window.scrollY > 80 && !scrollingUp){
  ...
  if(window.scrollY > 90 && !scrollingUp){
  ...
  if(window.scrollY > 100 && !scrollingUp){
   ...
   if(window.scrollY > 110 && !scrollingUp){
