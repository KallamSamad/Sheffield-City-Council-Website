...
<div class="page">
    ...
    <h1 class="page-title">Hallam University- TOP 800 GLOBALLY</h1><!-- title -->

    <div class="eduComponents"> 
     
      <img src="Assets/Images/owen2.webp" width="600" alt="University of Hallam"><!--Image-->

      <button class="EducationArrowButton" onclick="window.location.href='SheffieldUniPage.php'"><!-- switch to sheffield uni page -->
 ...
 <ul class="EduInfo">
  ...
  <li style="font-size:25px; font-weight:bold;">
    ...
    if (!empty($CourseSearch)) {//if user searched for a course, run code, if empty, skip
        ...
        $stmt = $db->prepare('SELECT CourseID, CourseName FROM Course WHERE UniversityID = 2 AND CourseName LIKE :term'); // prepapre sql query to select all courses with matching course name from university id 2
