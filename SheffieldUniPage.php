...
<div class="page">
  <h1 class="page-title">University Of Sheffield - TOP 100 GLOBALLY</h1>
  ...
  if (!empty($CourseSearch)) {
      ...
      $stmt = $db->prepare('SELECT CourseID, CourseName FROM Course WHERE UniversityID = 1 AND CourseName LIKE :term');
